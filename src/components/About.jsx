      ...
      <div className="max-w-7xl mx-auto ">
        ...
        >
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                key={stat.label}
                className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 text-center group hover:border-purple-400/50 transition-all duration-300"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-slate-800/50 backdrop-blur-md rounded-2xl p-8 border border-slate-700/50 group hover:border-purple-400/30 transition-all duration-300">
            ...
            >
              <h4 className="text-lg font-semibold text-purple-300 mb-3">Core Expertise</h4>
            ...
            <motion.div
              ...
              transition={{ delay: 0.3 }}
            >
              <h4 className="text-lg font-semibold text-purple-300 mb-3">Exploring Technologies</h4>
              <div className="flex flex-wrap gap-2">
                {["Typescript", "Docker", "Kubernetes", "AWS"].map((skill, index) => (
                  <motion.span
                    key={skill}
                    className="px-3 py-1 bg-purple-500/20 text-purple-200 rounded-full text-sm border border-purple-500/30"
                    initial={{ opacity: 0, scale: 0 }}
